...
export HOMETEL=/home/scorpion/telemac/v8p4/
...
### MED  -----------------------------------------------------------
export MEDHOME=$SYSTEL/med-4.1.1
...
### METIS -------------------------------------------------------------
export METISHOME=/home/scorpion/telemac/v8p4/metis-5.1.0/build/
export LD_LIBRARY_PATH=$METISHOME/lib:$LD_LIBRARY_PATH
### AED
export AEDHOME=$SYSTEL/aed2_1.2
